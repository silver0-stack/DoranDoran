...
class ReceivedMemberAdapter(private val context: Context, private val dataList: ArrayList<receivedMemberData>) :
    RecyclerView.Adapter<ReceivedMemberAdapter.ItemViewHolder>() {
    ...
    inner class ItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val badge=itemView.findViewById<TextView>(R.id.badge)//뱃지

        @SuppressLint("SetTextI18n")
        fun bind(memberData: receivedMemberData, context: Context) {
...
//            Log.d("mPosition: ", mPosition.toString())
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ):ReceivedMemberAdapter.ItemViewHolder {
